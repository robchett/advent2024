...
return new class($input) implements Task {
    ...
    #[\Override] public function task1(): TaskOutput
    {
        ...
        $i = 0;
        while($i < 25) {
            foreach ($stones[$i] as $n => $c) {
                if ($n == 0) {
                    $stones[$i+1][1] ??= 0;
                    $stones[$i+1][1] += $c;
                    continue;
                }
                if (($s = strlen((string) $n)) % 2 == 0) {
                    $a = (int) substr($n, 0, $s / 2);
                    $stones[$i+1][$a] ??= 0;
                    $stones[$i+1][$a] += $c;
                    $b = (int) substr($n, $s / 2);
                    $stones[$i+1][$b] ??= 0;
        ...
        return new TaskOutput(array_sum($stones[25]));
    }
    ...
    #[\Override] public function task2(): TaskOutput
    {
        ...
        return new TaskOutput(array_sum($stones[75]));
    }
};